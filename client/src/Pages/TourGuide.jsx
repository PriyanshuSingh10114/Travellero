...
const TourGuide = () => {
  return (
    <>
      <div className="section-banner h-90 lg:h-150 bg-center bg-cover flex justify-center items-center text-white bg-no-repeat relative"
        style={{
        ...
        <div className="section-content z-0 text-center">
            ...
            <ul className="flex items-center flex-wrap justify-center gap-2">
                ...
                <li>
                    <Link to="/tourguide" className="cursor-pointer text-sm lg:text-lg font-medium text-secondary"></Link>
                </li>
            </ul>
        </div>
      </div>
