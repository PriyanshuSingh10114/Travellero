    ...
    <>
        ...
        <div
            ...
            <div className="section-content z-0 text-center">
                <h4 className="text-2xl lg:text-4xl xl:text-6xl font-extrabold text-secondary">Frequently Asked Questions
                </h4>
                <ul className="flex items-center flex-wrap justify-center gap-2">
                    ...
                    <li>
                        <Link to="/services" className="cursor-pointer text-sm lg:text-lg font-medium text-secondary">Frequently Asked Questions</Link>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div className='px-[2%] sm:px-[8%] py-[6%] md:py-[8%] flex justify-between items-start xl:flex-row flex-col gap-12 h-auto xl:h-250 bg-[#Efffff]'>
            ...
            <div className="w-full xl:w-[50%] title relative h-full">
                  <h1 className="text-secondary text-4xl md:text-6xl font-bold">
                    Find<span className="text-yellow">
                      Answers
                      </span>{" "}
                      for Questions You Have.
                  </h1>
            ...
            <div className="w-full lg:w-[50%] title relative h-full p-5 sm:py-10 sm:px-10 md:py-15 md:px-12.5 rounded-2xl border border-gray-200 backdrop-blur-[5px]">
                ...
                <form method="post" className="space-y-8">
                    <input
                        ...
                        className="w-full rounded-full px-6 py-4 text-gray-700 placeholder-gray-500 font-light bg-white outline-none transition duration-300" required
                    />
                    ...
                    <textarea rows="5" placeholder='Message' className="w-full rounded-3xl px-6 py-4 text-gray-700 placeholder-gray-500 font-light bg-white outline-none transition duration-300" required></textarea>
