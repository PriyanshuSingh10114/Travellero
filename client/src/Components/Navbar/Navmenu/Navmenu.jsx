...
function Navmenu({menuOpen,toggleMenu}) {
  ...
  const [tourGuideOpen, setTourGuideOpen] = React.useState(false)
  ...
  return (
    ...
    <ul className="lg:flex hidden items-start gap-10 text-white">
      ...
      <li>
        <Link to="/" className="font-semibold text-lg hover:text-prim transition">
          Home
        </Link>
      </li>

      <li>
        <Link to="/about" className="font-semibold text-lg hover:text-prim transition">
          About
        </Link>
      </li>
      ...
      <li className="relative group">
        <div className="font-semibold cursor-pointer flex items-center text-lg hover:text-prim transition">
          Pages
          <Icon
      ...
      <li>
        <Link to="/destination" className="font-semibold text-lg hover:text-prim transition">
          Destination
        </Link>
      </li>

      <li>
        <Link to="/tours" className="font-semibold text-lg hover:text-prim transition">
          Tours
        </Link>
      </li>

      <li>
        <Link to="/blogs" className="font-semibold text-lg hover:text-prim transition">
          Blog
        </Link>
      </li>

      <li>
        <Link to="/contact" className="font-semibold text-lg hover:text-prim transition">
          Contact
        </Link>
      </li>
    ...
    >
      ...
      >
        ...
        <div className='lg:block:hidden'>
          <Logo/>
          <h3 className='pt-12 text-3xl pb-8 text-gray-300'>
          ...
          <div>
            <h3 className="pt-12 text-3xl pb-10 text-gray-300">
            ...
            <ul className="w-full grid grid-cols-3 gap-8">
              ...
              <li className="text-center">
                ...
                <p className="text-xl font-medium text-gray-300">Basic Plan</p>
              </li>

              <li className="text-center">
                <span className="text-prim text-2xl">$299</span>
                <p className="text-xl font-medium text-gray-300">Pro Plan</p>
              </li>

              <li className="text-center">
                <span className="text-prim text-2xl">$399</span>
                <p className="text-xl font-medium text-gray-300">Full Plan</p>
              </li>   
            </ul>
          </div>
          ...
          <ul className="pt-20 flex items-center">
            ...
            <li className="social-icon inline-flex h-11.5 w-11.5 bg-yellow me-2.5 rounded-full overflow-hidden justify-center items-center transition-all duration-500 ease-in-out group hover:rounded-[10px] hover:shadow-lg">
              <Link
                to="//https://x.com/"
                className="h-9 w-9 flex justify-center items-center bg-secondary text-white text-[18px] rounded-full transition-all duration-500 ease-in-out group-hover:text-yellow group-hover:rounded-[10px]"
              >
      ...
      <ul className="space-y-5 lg:hidden block">
        ...
        <li className='relative'>
          ...
          <ul
            className={`mt-2 text-white border border-gray-50/10 shadow-lg rounded-xl transition-all duration-300 z-50 w-fit lg:min-w-full min-w-50 ${
              pagesOpen
          ...
          >
            ...
            <li className='relative'>
              ...
              className='flex justify-between items-center px-4 py-2 cursor-pointer'>
                ...
                width="20"
                height="20"
                className={`transition-transform duration-300 ${tourGuideOpen ? "rotate-90":""}`}
                />
              </div>

              <ul className={`min-w-52 bg-white/20 text-white overflow-hidden transition-all duration-300 ease-in-out ${tourGuideOpen ? "max-h-40 opacioty-100 translate-y-0" : "max-h-0 opacity-0 translate-y-2"}`}>
        ...
        <li>
          <Link to='/destinations' className='font-medium text-lg hover:text-prim  transition-colors duration-300'>
            Destinations
          </Link>
        </li>
